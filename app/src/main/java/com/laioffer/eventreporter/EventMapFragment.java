...
public class EventMapFragment extends Fragment
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Log.i("current Location", curLatitude + " : " + curLongitude);
    ...
    /*
    *   when user clicks on info windows when it pops up, the following code will be triggered
     */
    @Override
        ...
        database.child("events").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (Event event : events) {
                    ...
                    // adding marker
                    Marker mkr = googleMap.addMarker(marker);
                    mkr.setTag(event);
                }
    ...
    /*
    *   when user click the marker, add images to icon
     */
    @Override
